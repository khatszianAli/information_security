...
smtp_port = 587
sender_email = "hanzian53@gmail.com"  # Replace with your email address
sender_password = "qcha ylst luyu pmez"     # Replace with your email password or app-specific password
receiver_email = "hanzian67@gmail.com"  # Replace with the recipient's email
